...
3. WebAssembly for `{teal}` — what's feasible today? (Note: `{golem}` was incompatible with webR; framework choices matter)
4. Could Nix/Rix offer a lighter-weight alternative to containers for reproducible environments?
